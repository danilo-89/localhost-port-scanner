...
const InfoSection = () => {
	...
	return (
		<>
			<section className='relative p-8 w-full bg-yankeesBlue mb-7 flex rounded-lg items-center'>
				<div>
				...
				{isValidPercent ? (
					<div className='absolute left-0 right-0 top-0 h-1 rounded-t-lg overflow-hidden bg-charcoal'>
						<div
							className={clsx(
								'w-full h-full bg-gradient-to-r from-[#17aaf8] to-[#7ce664] origin-left',
								scanningResult.percentOfScanning !== 0 && 'transition-transform'
							)}
							style={{
